...
public class ItemsRouterIntegrationTest extends IntegrationTest {

  public static final String URL = "/v2";
  @Autowired
  ...
  @Test
  public void failDeleteById_withNotFound(){
    //Given
    final UUID seed = UUID.randomUUID();
    final ErrorDto expected = ErrorDto.builder()
        ...
        .build();
    //When
    final EntityExchangeResult<ErrorDto> actual = webTestClient.delete()
        .uri(URL +"/items/"+seed.toString())
        .accept(MediaType.APPLICATION_JSON)
        .exchange()
        .expectStatus()
  ...
  public void Update(){
    ...
    //When
    final EntityExchangeResult<ItemDto> actual = webTestClient.put()
        .uri(URL +"/items")
        .accept(MediaType.APPLICATION_JSON)
